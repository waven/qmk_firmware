...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FL] = LAYOUT_3x2(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, QK_BOOT, CLOCK_SET,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MPRV, KC_MNXT, KC_MSTP, KC_PSCR,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MPLY,          KC_SCRL,
  ...
  [_CL] = LAYOUT_3x2(
    ...
    _______, _______, _______, KC_CAPS, _______, _______, KC_NUM,  KC_KP_1, KC_KP_2, KC_KP_3, KC_KP_DOT,   _______,          M_UNCOM, KC_END,
