...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FL] = LAYOUT_65_ansi_blocker( \
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MPRV, KC_MNXT, KC_MSTP, _______,  \
    ...
    _______, _______, _______,          KC_KP_0,                                     _______, KC_NUM,                 SFT_TAB, M_COM,   KC_TAB  \
  ),
};
