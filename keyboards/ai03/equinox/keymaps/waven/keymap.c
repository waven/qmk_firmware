...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_all(
    QK_GESC, _______, _______, _______, _______, _______, _______, _______, KC_UP,   KC_LBRC, KC_RBRC, KC_BSLS,
    MO(4),   KC_INS,  KC_PSCR, KC_PAUS, KC_SCRL, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_QUOT, TD(TD_PUH),
  ...
  [4] = LAYOUT_all(
    QK_BOOT, _______, _______, _______, _______, _______, _______, _______, M_UNCOM, KC_MPRV, KC_MNXT, KC_MSTP,
