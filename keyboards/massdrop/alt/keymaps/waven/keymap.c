...
enum alt_keycodes {
    L_BRI = NEW_SAFE_RANGE, //LED Brightness Increase
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FL] = LAYOUT(
    ...
    _______, L_T_MD,  L_T_ONF, _______, _______, MD_BOOT, TG_NKRO, _______, _______, _______, _______, _______,          KC_VOLU, _______, \
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    if (keycode >= SAFE_RANGE && keycode < NEW_SAFE_RANGE){
