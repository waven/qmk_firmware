...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [_FL] = LAYOUT_65_ansi_blocker(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MPRV, KC_MNXT, KC_MSTP, KC_SCRL,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          KC_MPLY, _______,
        _______,          _______, _______, _______, _______, _______, KC_MUTE, _______, _______, _______, _______, _______, KC_VOLU, _______,
    ...
    [_CL] = LAYOUT_65_ansi_blocker(
        ...
        _______,          _______, _______, KC_CAPS, _______, _______, KC_NUM,  KC_KP_1, KC_KP_2, KC_KP_3,     KC_KP_DOT, _______, M_UNCOM, _______,
