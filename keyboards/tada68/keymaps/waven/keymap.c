...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * ├─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┤
   * │LCTRL│L_GUI│L_ALT│█████│█████│ SPC │█████│█████│█████│R_ALT│     │RCTRL│LEFT │DOWN │RIGHT│
   * └─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┘
   */
  ...
  [_DL] = LAYOUT_ansi(
    ...
    KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,                             KC_RALT, XXXXXXX, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
  ),
...
/* 2: CapsLock Function layer
  ...
  [_CL] = LAYOUT_ansi(
    ...
    _______, _______, _______,                   _______,                            KC_NLCK, _______,     _______,   SFT_TAB, M_COM,   KC_TAB
  ),
};
